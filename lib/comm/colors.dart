...
class Colours {
  ...
  static const Color dark_app_main = Colors.white;

  static const Color app_primary = Colors.purple;
  static const Color dark_app_primary = Colors.deepPurpleAccent;
  ...
  static const Color text_disabled = Colors.grey;
  static const Color dark_text_disabled = Colors.grey;

  static const Color button_disabled = Colors.grey;
  static const Color dark_button_disabled = Colors.grey;
